<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-4 py-4 flex justify-between items-center">
                    ...
                    <button onclick="return filterData()">Filter trsKembali</button>
                </div>
    ...
    <div id="modal-filterData" class="hidden fixed inset-0 flex justify-center items-center m-4">
        <div class="bg-white rounded-lg p-6 lg:w-4/12 w-full shadow-xl">
            <h2 class="text-lg font-bold mb-4 bg-amber-100 p-2 rounded-xl">Filter trsKembali</h2>
            <form id="filterForm" action="{{ route('reportKembali.index') }}" method="get" class="w-full">
                @csrf
